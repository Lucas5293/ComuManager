 ...
 * @author lucas
 */
public class ViewConPergunta extends javax.swing.JPanel {

    /**
     * Creates new form ViewConPergunta
     */
    public DefaultTableModel modelo;
    
    public ViewConPergunta() {
        initComponents();
          jTable1.setAutoCreateRowSorter(true);
        //jTable1.set
        modelo = (DefaultTableModel) jTable1.getModel();  
        modelo.setRowCount(0);
        modelo.setColumnIdentifiers(new Object[]{"id","descrição","tipo","questionário id"});
    }
